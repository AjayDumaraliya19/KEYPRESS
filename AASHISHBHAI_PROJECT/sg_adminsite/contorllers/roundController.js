...
const { roundDetailsSchema,TicketDetailsSchema, TicketDataSchema } = require('../validation');
...
const ticketInfoByTicketId = async (req, res) => {
    ...
    try {
        ...
        const TData = await getDataByField(connection, tableName, `TicketId = '${req.body.tid}'`, 'TicketInfoId, TicketId,IP, IPInfo, DeviceInfo')
