exports.joinsTwoTbl = async (connection, tb1, tb2, fields, cond1, whereCondition) => {
	let obj = {
		error: null,
		data: null
	};
...
exports.joinsTwoTb = async (connection, tb1, tb2, fields, cond1, whereCondition, limit, page, body) => {
	page = ((page - 1) * limit)
	let obj = {
		error: null,
		data: null
...
exports.threeJoins = async (connection, tb1, tb2, tb3, fields, cond1, cond2, whereCondition, limit, page) => {
	page = ((page - 1) * limit)
	let obj = {
		error: null,
		data: null
