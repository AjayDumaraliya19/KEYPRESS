...
//===============User Route ==============
const { userCreate, login, listUser, deleteUser, updateUser } = require('../contorllers/userController');
...
//===============Game Route ===============
const { insertGame, updateGame, updateGameDetails, deleteGame, gameList, gameWithoutPagination, gameDetailsByGameCode, LastTenWinners ,StartGame,Getallgame} = require('../contorllers/gameContoller');
...
//===============Partner Route ===============
const { insertPartner, updatePartner, deletePartner, listPartner, listPartnerGameByPartnerId, deletePartnerGame, updatePartnerGame, insertPartnerGame, GetAllPartner, getPlayerByPartnerId} = require('../contorllers/partnerController');
...
router.post('/allpartner', auth, GetAllPartner);
router.post('/allplayers', auth, getPlayerByPartnerId);
...
//===============Report Route ===============
const { GetRoundReport ,GetRounDetailsdReport} = require('../contorllers/ReportController');
